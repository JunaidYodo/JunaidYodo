...
### 🔐 Security & IAM
![HashiCorp Vault](https://img.shields.io/badge/HashiCorp%20Vault-FFD814?style=for-the-badge&logo=vault&logoColor=black)
...
| ✈️ | **Trip Slice** | Smart trip planning with AI intent detection & itinerary generation | FastAPI · LangChain · WebSockets |
| 🔒 | **Secret Manager** | Enterprise vault with RBAC, dynamic secrets, audit logs & modern dashboard | Python · DRF · React.js |
| 🌐 | **AI Immigration** | Visa suitability advisory with document analysis & eligibility engine | Django · LLMs · Vector DB |
| 📚 | **Bleks Reading** | Student assessment platform with Whisper STT & automated AI scoring | FastAPI · Whisper · Qdrant |
| ✅ | **AI Verify** | AI-generated media detection & malware URL scanning platform | Django · VirusTotal · Hive AI |
| 💰 | **Quantum Edge** | FinTech budget management & property investment forecasting platform | Flask · LangChain · PostgreSQL |
